...
for `software` and `hardware`, I also completed FB synthesize Part B for both `software` and `hardware`. Both of my Part A and Part B is about economics. I completed these in my [notes](https://docs.google.com/document/d/1Ob0IVBj5geUdPDqY5nFb1ioquE-PBDo0YSjW7TlT414/edit?usp=drivesdk) for SEP10.
### My FB synthesize Part A for `software`:
### 1st website
